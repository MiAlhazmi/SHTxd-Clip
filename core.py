...
class UpdateChecker:
    """Enhanced update checker with self-updating yt-dlp and app updates"""

    def __init__(self):
        self.callbacks: Dict[str, Callable] = {}
        self.yt_dlp_updater = YtDlpUpdater()

    def set_callbacks(self, callbacks: Dict[str, Callable]):
        """Set callback functions"""
        self.callbacks = callbacks
        self.yt_dlp_updater.set_callbacks(callbacks)
    ...
    def check_version(self) -> Optional[str]:
        ...
        return self.yt_dlp_updater.get_current_version()

    def update_ytdlp(self) -> bool:
        """Update yt-dlp using self-updater"""
        return self.yt_dlp_updater.update_yt_dlp()

    def auto_update_ytdlp_on_startup(self) -> bool:
        """Auto-update yt-dlp on startup"""
        return self.yt_dlp_updater.auto_update_check()
